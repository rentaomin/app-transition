package com.rtm.application.governance.mybatis.mapper;
...
public interface SysUserMapper {
	...
	void batchUpdateValueByPropKey(List<SysUser> paramList);

	List<Map<String, Object>> getSysMenuInfo(Map<String, Object> map);
